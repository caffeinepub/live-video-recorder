...
export class Backend implements backendInterface {
    ...
    async deleteEmergencyContact(arg0: string): Promise<boolean> {
        if (this.processError) {
            try {
    ...
    async getTwilioSettings(): Promise<{
        accountSid: string;
        fromPhone: string;
        hasAuthToken: boolean;
    } | null> {
        if (this.processError) {
            try {
                const result = await this.actor.getTwilioSettings();
    ...
    async listEmergencyContacts(): Promise<Array<EmergencyContact>> {
        if (this.processError) {
            try {
                const result = await this.actor.listEmergencyContacts();
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async saveTwilioSettings(arg0: string, arg1: string, arg2: string): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.saveTwilioSettings(arg0, arg1, arg2);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async sendEmergencyAlerts(arg0: string, arg1: string): Promise<Array<SMSResult>> {
        if (this.processError) {
            try {
                const result = await this.actor.sendEmergencyAlerts(arg0, arg1);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
